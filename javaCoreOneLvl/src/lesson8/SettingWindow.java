...
public class SettingWindow extends JFrame { // Создаем класс настроек наследуемый от JFrame
    private GameWindow gameWindow; // Создаем приватную переменную от класса GameWindow
